...
var Logo = paper.Base.extend({
	...
	update: function(dt){
		...
		for(var i = 0, len = this._bg.children.length - 1; i < len; i++){
			var connection = this._createConnection(this._bg.children[i], this._bg.children[i+1], 0.45, Math.PI, this._radius * 3.6);
			if(connection){
